...
# download redpill
git clone  -b master --depth=1 https://github.com/RedPill-TTG/redpill-lkm.git
...
#./ext-manager.sh add https://raw.githubusercontent.com/jumkey/redpill-load/develop/redpill-boot-wait/rpext-index.json
